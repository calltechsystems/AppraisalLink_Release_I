...
public partial class AppraisallandsContext : DbContext
{
    public AppraisallandsContext()
    {
    }

    public AppraisallandsContext(DbContextOptions<AppraisallandsContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PaypalTransactionLog>(entity =>
        {
            ...
            entity.Property(e => e.SubscriberEmailId)
                .HasColumnType("character varying")
                .HasColumnName("Subscriber_EmailId");
            entity.Property(e => e.SubscriberPhoneId)
                .HasColumnType("character varying")
                .HasColumnName("Subscriber_PhoneId");
            entity.Property(e => e.SubscriberProfileName)
                .HasColumnType("character varying")
        ...
        modelBuilder.Entity<Plan>(entity =>
        {
            ...
            entity.Property(e => e.PayPalProductId)
                .HasColumnType("character varying")
        ...
        modelBuilder.Entity<Property>(entity =>
        {
            ...
            entity.Property(e => e.AttachmentFlag).HasColumnName("attachment_flag");
            entity.Property(e => e.BidLowerRange).HasColumnName("bid_lower_range");
            entity.Property(e => e.BidUpperRange).HasColumnName("bid_upper_range");
            entity.Property(e => e.City)
                .HasMaxLength(50)
        ...
        modelBuilder.Entity<Subscription>(entity =>
        {
            ...
            entity.Property(e => e.SubscriptionId).HasColumnName("subscription_id");
            entity.Property(e => e.CurrencyCode).HasColumnType("character varying");
            entity.Property(e => e.EndDate)
                .HasColumnType("timestamp without time zone")
