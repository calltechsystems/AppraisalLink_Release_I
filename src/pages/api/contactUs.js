...
import CryptoJS from "crypto-js";
 ...
 async function handler (request,response) {
  ...
  try {
    ...
    const {firstName,lastName,emailAddress,userLoggedIn,phoneNumber,company,state,subject,description,token} = body;
    ...
    const userResponse = await axios.post(`${domain}/Contactus`, formData,
    {
      headers: {
