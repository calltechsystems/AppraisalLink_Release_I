...
const Form = () => {
        ...
        const [passwordRegisterVerified,setPasswordRegisterVerified] = useState(false)
      ...
      <div className="col-lg-6">
        <form onSubmit={registerHandler}>
          ...
          <div className="col-lg-12">
            <div className="form-group input-group ui_kit_select_search mb-3">
              ...
              >
                ...
                <option data-tokens="SelectRole" value={1}>Mortgage Broker</option>
                <option data-tokens="Agent/Agency" value={2}>Mortgage Brokerage</option>
                <option data-tokens="SingleUser" value={3}>Appraiser</option>
                <option data-tokens="SingleUser" value={4}>Appraiser Company</option>
              </select>
            </div>
          </div>
          {/* End from-group */}
          ...
          <div className="col-lg-12" style={{marginTop:"10px"}}>
            <div className="form-group input-group  " style={{ position: 'relative', marginBottom: '6px' }}>
          ...
          { isFocused ? passwordRegisterVerified ? <span style={{color:"green"}}>Strong Password &#10004;</span>
