...
public partial class CalltechContext : DbContext
{
    ...
    public virtual DbSet<RecurringPlan> RecurringPlans { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=calltech.c38hfagnq7z2.us-east-1.rds.amazonaws.com;Port=5432;Database=calltech;Username=calltech;Password=calltech1234;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bid>(entity =>
        {
            ...
            entity.Property(e => e.AppraiserAssign).HasColumnName("appraiser_assign");
        ...
        {
            entity.HasKey(e => e.Id).HasName("recurring_plans_pkey");

            entity.ToTable("recurring_plans");
        ...
        modelBuilder.Entity<RecurringProduct>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .HasMaxLength(50)
                .HasDefaultValueSql("nextval('recurring_product_id_seq'::regclass)")
                .HasColumnName("id");
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.Name)
                .HasMaxLength(255)
        ...
        modelBuilder.HasSequence("order_id_new_sequence")
            .StartsAt(10000L)
            .IncrementsBy(5);
        modelBuilder.HasSequence("properties_order_id_seq")
            .StartsAt(1000L)
            .IncrementsBy(5);
