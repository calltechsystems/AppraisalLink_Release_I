        ...
        public async Task<IActionResult> quoteActionByBroker(int QuoteID)
        {
            ...
            try
            {
                ...
                if (subscription != null)
                {
                    ...
                    {
                        int topUpTotalProperties = topUp_property == 0 ? 0 : topUp_property;
                        restProperty = (topUpTotalProperties + subscription.TotalProperties) - Obj_bids.SelectMany(innerList => innerList).Count();
                    }
                }
                else
                {
                ...
                if (restProperty > 0)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        else
                        {
                            ...
                            transactions.UsedProperties = (short)Math.Abs(acceptedbid - (subscription.TotalProperties + transtionproperty));
