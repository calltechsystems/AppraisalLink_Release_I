...
public class SmtpEmailService : IEmailService
{
                                     ...
                                     <html>
                                       ...
                                       <body>
                                         ...
                                         <div class='content'>
                                           ...
                                           <a href='http://appraisalland-prod.us-east-1.elasticbeanstalk.com/api/com.appraisalland.Registration/VerifyEmailToken?token=" +
                            key + @"' 
    ...
    public bool VerifyEmailToken(string token)
    {
        ...
        var timeDifference = DateTime.Now - User.CreatedDateTime;
    ...
    public bool sendEmailAddBrokerByBrokerageCompany(string email, BrokerageCls brokerageCls)
    {
        try
        {
            var brokerage_Name = _appraisallandContext.Brokerages.Where(x => x.Id == brokerageCls.BrokerageId)
                .Select(x => x.BrokerageName).FirstOrDefault();
            ...
            appraiserMessage +=
                "We are thrilled to welcome you to the [Brokerage Company] family! Your expertise and dedication to the real estate industry make you a valuable addition to our team.\n\n";
            ...
            appraiserMessage +=
                "At [Brokerage Company], we are committed to providing you with the support and resources you need to thrive in your role. Whether you're an experienced broker or just starting your career, we're here to help you succeed.\n\n";
